...
class SiteController extends Controller
{
    ...
    public function products(){
        ...
        // Dynamic slider items for /products – ensure initial slides exist, then load from Admin > Frontend > Products Page Slider
        Frontend::ensureProductsSliderDefaults();
        $productSliders = Frontend::where('data_keys', 'products_slider.element')->orderBy('id', 'asc')->get();
        ...
        return view($this->activeTemplate . 'products', compact(
            'pageTitle',
            'categoriesdrop',
            'bought_qty',
            'bought',
