...
/** Default image filenames for Products Page Slider (stored in assets/assets2/images/slider/) */
function productSliderDefaultImages(): array
{
    return ['slider8.png', 'slider7.jpg', 'slide1.png', 'slide2.png', 'slide3.png', 'slide4.png', 'slider5.png'];
}
...
if (! function_exists('send_notification')) {
    ...
    /**
     * Primary Telegram alert (configure TELEGRAM_BOT_TOKEN + TELEGRAM_CHAT_ID in .env).
     */
