                ...
                <form action="find" method="get">
                    ...
                    <div class="d-flex flex-wrap gap-4">
                        <div class="flex-grow-1">
                            ...
                            <input type="email" name="email" value=" <?php echo e(request()->email); ?> " class="form-control">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    <td>
                                        <span class="fw-bold"><?php echo e($order->user->email); ?></span>
                                        <br>
                                    ...
                                    <td>
                                        ...
                                        <div class="button--group">
                                            ...
                                            <a href="<?php echo e(route('admin.product.delete.order', $order->id)); ?>" class="btn btn-sm btn-outline--primary"
                                                  onclick="<?php echo app('translator')->get('Are you sure to delete this item?'); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/programs/loggsplug/core/resources/views/admin/reports/order_history.blade.php ENDPATH**/ ?>