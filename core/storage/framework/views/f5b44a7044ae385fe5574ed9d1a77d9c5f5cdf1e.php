                            ...
                            <table class="table table--light style--two custom-data-table">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <?php if(@$section->element->images): ?>
                                        <?php
                                            $firstKey = collect($section->element->images)->keys()[0];
                                            $thumbVal = @$data->data_values->$firstKey;
                                            $thumbSrc = ($key === 'products_slider' && $thumbVal && in_array((string)$thumbVal, productSliderDefaultImages(), true))
                                                ? asset('assets/assets2/images/slider/' . $thumbVal)
                                                : getImage('assets/images/frontend/' . $key . '/' . $thumbVal, @$section->element->images->$firstKey->size);
                                        ?>
                                            <td>
                                                <div class="customer-details d-block">
                                                    <a href="javascript:void(0)" class="thumb">
                                                        <img src="<?php echo e($thumbSrc); ?>" alt="<?php echo app('translator')->get('image'); ?>">
                                                    </a>
                                                </div>
                                            </td>
                                        <?php endif; ?>
                                                ...
                                                <?php
                                                    ...
                                                    if(@$section->element->images){
                                                        foreach($section->element->images as $imgKey => $imgs){
                                                            $iv = @$data->data_values->$imgKey;
                                                            $images[] = ($key === 'products_slider' && $iv && in_array((string)$iv, productSliderDefaultImages(), true))
                                                                ? asset('assets/assets2/images/slider/' . $iv)
                                                                : getImage('assets/images/frontend/' . $key . '/' . $iv, @$section->element->images->$imgKey->size);
                                                        }
                                                    }
                                                ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/programs/loggsplug/core/resources/views/admin/frontend/index.blade.php ENDPATH**/ ?>