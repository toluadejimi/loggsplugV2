<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card-body p-5">
                        <ul class="list-group list-group-flush text-center">
                            ...
                            <li class="text-center px-0">
                                <h6><?php echo e(__($deposit->method_currency)); ?> <?php echo e(showAmount($amount)); ?> </h6>
    ...
    ">
                        ...
                        <svg class="cart me-2" width="16" height="16" viewBox="0 0 18 18" fill="none"
                            ...
                            PAY NGN <?php echo e(showAmount($amount)); ?>
...
<?php echo $__env->make($activeTemplate.'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/programs/loggsplug/core/resources/views/templates/basic/user/payment/Enkpay.blade.php ENDPATH**/ ?>