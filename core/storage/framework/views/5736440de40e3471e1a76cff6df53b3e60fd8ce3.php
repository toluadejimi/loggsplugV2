                ...
                <div class="row gy-4">
                    <div class="col-12">
                        ...
                        <div class="position-relative">
                            <input type="text" class="common-input common-input--bg common-input--withIcon" id="email" name="username" value="<?php echo e(old('username')); ?>" placeholder="infoname@mail.com">
                            <span class="input-icon"><img src="<?php echo e(url('')); ?>/assets/assets2/images/icons/envelope-icon.svg" alt=""></span>
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="position-relative">
                            ...
                            <span class="input-icon toggle-password cursor-pointer" id="#your-password"><img src="<?php echo e(url('')); ?>/assets/assets2/images/icons/lock-icon.svg" alt=""></span>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="flx-between gap-1">
                            ...
                            <a href="<?php echo e(route('user.password.request')); ?>" class="forgot-password text-decoration-underline text-main text-poppins font-14">Forgot password?</a>
                        </div>
                    </div>
                    ...
                    <div id="g_id_onload"
                         ...
                         data-context="signin"
                         data-ux_mode="popup"
                         data-login_uri="<?php echo e(url('')); ?>/auth/google/callback"
...
<?php /**PATH /Applications/programs/loggsplug/core/resources/views/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>