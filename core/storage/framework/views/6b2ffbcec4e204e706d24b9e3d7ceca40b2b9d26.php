...
<div class="page-wraper">
                ...
                <div class="container">
                    <div class="header-content">
                        <div class="left-content">
                            ...
                            <?php elseif(str_starts_with(Route::current()->getName() ?? '', 'user.reseller')): ?>
    ...
    <div class="sidebar">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a class="nav-link" href="<?php echo e(route('user.reseller.index')); ?>">
                        <span class="dz-icon">
...
<?php /**PATH /Applications/programs/loggsplug/core/resources/views/templates/basic/layouts/nofooter.blade.php ENDPATH**/ ?>