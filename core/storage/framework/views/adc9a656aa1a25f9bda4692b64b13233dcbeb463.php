<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-body__content product-detail-page">
        ...
        <a href="<?php echo e(route('products')); ?>" class="product-detail-back d-inline-flex align-items-center gap-2 text-muted text-decoration-none mb-4">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="product-detail-card card border-0 shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        <h1 class="product-detail-title mb-3"><?php echo e(__($product->name)); ?></h1>
                        <div class="product-detail-meta d-flex flex-wrap align-items-center gap-2 mb-4">
                            <span class="product-detail-pill product-detail-pill--price"><?php echo e($general->cur_sym ?? 'NGN'); ?><?php echo e(number_format($product->price)); ?> <small>/ pcs</small></span>
                            <span class="product-detail-pill product-detail-pill--stock"><?php echo e(number_format($product->in_stock)); ?> in stock</span>
                        </div>
                        ...
                        <form id="buyForm" action="<?php echo e(route('user.deposit.insert')); ?>" method="POST" class="product-detail-form">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="product-detail-order-row row align-items-center g-3 mb-4">
                                <div class="col-auto">
                                    ...
                                    <input type="number"
                                           ...
                                           value="1"
                                           min="1"
                                           max="<?php echo e(min($product->in_stock, 100)); ?>"
                                           aria-label="Quantity">
                                </div>
                                <div class="col">
                                    <label class="form-label small text-muted mb-1 d-block">Total</label>
                                    <p class="product-detail-total mb-0 fw-700"><?php echo e($general->cur_sym ?? 'NGN'); ?><span id="total"><?php echo e(number_format($product->price, 2)); ?></span></p>
                                </div>
                            </div>
        ...
        <?php if(isset($relatedProducts) && $relatedProducts->isNotEmpty()): ?>
            <section class="product-detail-related mt-5 pt-4">
                ...
                <div class="row g-3">
                    <?php $__currentLoopData = $relatedProducts->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-6 col-md-3">
                            <a href="<?php echo e(route('product.details', $rel->id)); ?>" class="product-detail-related-card card border-0 shadow-sm h-100 text-decoration-none text-dark">
                                <img src="<?php echo e(getImage(getFilePath('product') . '/' . $rel->image, getFileSize('product'))); ?>"
                                     alt="<?php echo e(__($rel->name)); ?>"
                                     class="card-img-top product-detail-related-img">
                                <div class="card-body py-2 px-3">
                                    <p class="small fw-600 mb-1 text-truncate"><?php echo e(__($rel->name)); ?></p>
                                    <p class="small text-muted mb-0"><?php echo e($general->cur_sym ?? 'NGN'); ?><?php echo e(number_format($rel->price)); ?></p>
                                </div>
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        (function() {
            ...
            if (quantityEl && totalEl) {
                var price = <?php echo e($product->price); ?>;
                function syncTotal() {
...
<?php echo $__env->make($activeTemplate . 'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/programs/loggsplug/core/resources/views/templates/basic/product_details.blade.php ENDPATH**/ ?>