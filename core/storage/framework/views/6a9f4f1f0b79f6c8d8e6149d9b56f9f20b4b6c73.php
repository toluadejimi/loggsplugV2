                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(route('admin.report.order.history', ['search'=>$deposit->trx])); ?>" class="fw-bold"><?php echo app('translator')->get('View Details'); ?></a>
                        </li>
        ...
        <div class="col-xl-8 col-md-6 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <?php if($deposit->url != null): ?>
                        <a href="<?php echo e($deposit->url); ?>" >View Recepit</a>
                    <?php endif; ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo app('translator')->get('Reject Payment Confirmation'); ?></h5>
                ...
                <form action="<?php echo e(route('admin.deposit.reject')); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <p><?php echo app('translator')->get('Are you sure to'); ?> <span class="fw-bold"><?php echo app('translator')->get('reject'); ?></span> <span class="fw-bold withdraw-amount text-success"></span> <?php echo app('translator')->get('payment of'); ?> <span class="fw-bold withdraw-user"></span>?</p>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/loggsplu/public_html/core/resources/views/admin/deposit/detail.blade.php ENDPATH**/ ?>