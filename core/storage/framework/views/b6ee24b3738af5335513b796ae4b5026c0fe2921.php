<?php $__env->startSection('content'); ?>
                            ...
                            <table class="table deposit-history-table mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="deposit-td"><?php echo e(showDateTime($deposit->created_at, 'M d, Y')); ?></td>
                                            <td class="deposit-td">
                                                <?php if($deposit->method_code == 1000): ?>
                                                    Manual
                                                <?php elseif($deposit->method_code == 250): ?>
                                                    SprintPay
                                                <?php elseif($deposit->method_code == 251): ?>
                                                    Payment Point
                                                <?php else: ?>
                                                    —
                                                <?php endif; ?>
                                            </td>
                                            <td class="deposit-td deposit-td--amount">NGN <?php echo e(number_format($deposit->amount, 2)); ?></td>
    ...
    <script>
        document.getElementById('gateway-select').addEventListener('change', function () {
            ...
            <?php if(auth()->user()->name == null || auth()->user()->phone == null): ?>
            if (selected == 251) {
...
<?php echo $__env->make($activeTemplate . 'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/programs/loggsplug/core/resources/views/templates/basic/user/deposit_new.blade.php ENDPATH**/ ?>