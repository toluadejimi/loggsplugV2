                                        ...
                                        <tr class="text-small">
                                            <td class="text-dark">
                                                ...
                                                <a class="text-primary" href="<?php echo e(route('user.order.details', $order->id)); ?>">
                                                    ...
                                                    <?php echo e($order->id); ?> <?php echo e("| View Orders"); ?>
                                            ...
                                            <td class="text-dark">
                                                ...
                                                <?php $name = \App\Models\Product::where('id', $order->product_id)->first()->name ?? null; ?>
                                                <a class="text-primary" href="<?php echo e(route('user.order.details', $order->id)); ?>">
                                                    <?php echo e($name ?? "Product Name"); ?>
...
<?php echo $__env->make($activeTemplate.'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/loggsplu/public_html/core/resources/views/templates/basic/user/orders.blade.php ENDPATH**/ ?>