                        ...
                        <div class="swiper-slide">
                            <a href="<?php echo e($slideUrl); ?>" <?php if($external): ?> target="_blank" rel="noopener" <?php endif; ?>>
                                <div class="card products-slider-card">
                                    <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($data->title ?? 'wallet-image'); ?>" class="products-slider-img">
                                </div>
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="products-category-select-wrap">
                        <select id="urlSelect" onchange="redirectToUrl()" class="products-category-select">
                            ...
                            <?php $__currentLoopData = $categoriesdrop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(url('')); ?>/category-products/<?php echo e($data->name); ?>/<?php echo e($data->id); ?>"><?php echo e($data->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                                                ...
                                                <tr class="products-recent-row">
                                                    <td class="products-recent-cell">
                                                        <div class="products-recent-who">
                                                            <span class="products-recent-username"><?php echo e(\Illuminate\Support\Str::limit($data->user_name, 4, '.')); ?></span>
                                                            <span class="products-recent-badge">just purchased</span>
                                                        </div>
                                                        <div class="products-recent-item"><?php echo e(\Illuminate\Support\Str::limit($data->item, 24, '...')); ?></div>
                                                        <div class="products-recent-pills d-flex flex-wrap gap-2 mt-1">
                                                            <span class="products-recent-pill">₦<?php echo e(number_format($data->amount)); ?></span>
                                                        </div>
                                                    </td>
                                                    <td class="products-recent-time text-muted small text-end"><?php echo e(diffForHumans($data->created_at)); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </tbody>
