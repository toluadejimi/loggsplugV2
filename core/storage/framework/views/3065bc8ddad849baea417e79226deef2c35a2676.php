...
<section class="account d-flex">
    ...
    <div class="account__left d-md-flex d-none flx-align section-bg position-relative z-index-1 overflow-hidden">
        <img src="<?php echo e(url('')); ?>/assets/assets2/images/shapes/pattern-curve-seven.png" alt=""
                ...
                <div class="row gy-4">
                    <div class="col-12">
                        ...
                        <div class="position-relative">
                            <input required type="text" name="username" value="<?php echo e(old('username')); ?>"
                                   class="common-input common-input--bg common-input--withIcon" id="email"
                                   placeholder="john">
                            <span class="input-icon"><img src="<?php echo e(url('')); ?>/assets/assets2/images/icons/user-icon.svg"
                                                          alt=""></span>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="position-relative">
                            <input required type="text" value="<?php echo e(old('email')); ?>"
                            ...
                            <span class="input-icon"><img
                                    src="<?php echo e(url('')); ?>/assets/assets2/images/icons/envelope-icon.svg" alt=""></span>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="position-relative">
                            ...
                            <span class="input-icon toggle-password cursor-pointer" id="#your-password"><img
                                    src="<?php echo e(url('')); ?>/assets/assets2/images/icons/lock-icon.svg" alt=""></span>
                        </div>
                    </div>
...
<?php /**PATH /Applications/programs/loggsplug/core/resources/views/templates/basic/user/auth/register.blade.php ENDPATH**/ ?>