                ...
                <li class="sidebar-menu-item ">
                    <a href="/admin/payment-settings" class="nav-link"
                       data-default-url="payment-settings">
                        ...
                        <span class="menu-title"><?php echo app('translator')->get('Payment Settings'); ?> </span>
                    </a>
                </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/programs/loggsplug/core/resources/views/admin/partials/sidenav.blade.php ENDPATH**/ ?>