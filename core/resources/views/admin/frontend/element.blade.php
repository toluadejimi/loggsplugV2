                                                    ...
                                                    <div class="image-upload">
                                                        <div class="thumb">
                                                            <div class="avatar-preview">
                                                                @php
                                                                    $imgVal = isset($data->data_values->$imgKey) ? trim((string) $data->data_values->$imgKey) : '';
                                                                    $isDefaultSlider = $key === 'products_slider' && $imgVal !== '' && in_array($imgVal, productSliderDefaultImages(), true);
                                                                    $previewUrl = $isDefaultSlider
                                                                        ? asset('assets/assets2/images/slider/' . $imgVal)
                                                                        : getImage('assets/images/frontend/' . $key . '/' . $imgVal, @$section->element->images->$imgKey->size);
                                                                @endphp
                                                                <div class="profilePicPreview" style="background-image: url('{{ $previewUrl }}')">
