    ...
    <div class="row g-4 p-3 p-md-4">
            ...
            <div class="reseller-sidebar">
                <div class="reseller-sidebar__inner">
                    ...
                    <nav class="reseller-nav">
                        ...
                        <a href="{{ route('user.reseller.index') }}" class="reseller-nav__item"><i class="las la-store"></i> @lang('Reseller')</a>
                        <a href="{{ route('user.reseller.api-docs') }}" class="reseller-nav__item active"><i class="las la-book"></i> @lang('API Docs')</a>
        ...
        <div class="col-lg-9">
            <div class="reseller-hero mb-4">
                <h1 class="reseller-hero__title">@lang('Reseller API Documentation')</h1>
            ...
            <div class="reseller-card mb-4">
                <div class="reseller-card__body">
                    ...
                    <code class="reseller-apikey__value d-block py-2 px-3 rounded">{{ $baseUrl }}/reseller</code>
                </div>
            </div>
