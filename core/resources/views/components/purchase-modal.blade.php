            ...
            <div class="modal-content">
                ...
                <form action="{{ route('user.deposit.insert') }}" method="POST">
                    ...
                    <div class="modal-footer p-0 m-0 border-top-0">
                        <button type="submit" class="btn btn--base w-100 m-0"><i class="fas fa-angle-double-right"></i> @lang('Buy Now')</button>
                    </div>
                </form>
            </div>
        @else
        ...
        <script>
            (function ($) {
                ...
                $('.purchaseBtn').on('click', function () {
                    ...
                    modal.find('[name=qty]').val(1).attr('max', parseInt(qty) || 10000);
                    modal.modal('show');
                });
